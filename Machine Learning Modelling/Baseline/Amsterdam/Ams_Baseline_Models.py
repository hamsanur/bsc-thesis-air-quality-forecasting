...
INPUT_FILE = os.path.join(BASE_PATH, "airq_cleaned.csv")
TRAIN_FILE = os.path.join(BASE_PATH, "airq_amsterdam_train.csv")
TEST_FILE = os.path.join(BASE_PATH, "airq_amsterdam_test.csv")
LAG_RESULTS_FILE = os.path.join(BASE_PATH, "lag_results_amsterdam.csv")
METRICS_FILE = os.path.join(BASE_PATH, "metrics_pm25_amsterdam.csv")
