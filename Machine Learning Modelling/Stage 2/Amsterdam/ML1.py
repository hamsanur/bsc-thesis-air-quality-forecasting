...
TRAIN_FILE = os.path.join(BASE_PATH, "train_amsterdam.csv")
TEST_FILE  = os.path.join(BASE_PATH, "test_amsterdam.csv")

LAG_RESULTS_FILE = os.path.join(BASE_PATH, "lag_results_weather_amsterdam.csv")
METRICS_FILE = os.path.join(BASE_PATH, "metrics_weather_amsterdam.csv")
PFI_FILE = os.path.join(BASE_PATH, "permutation_importance_weather_amsterdam.csv")

PRED_DIR = os.path.join(BASE_PATH, "Predictions_Weather_Amsterdam")
